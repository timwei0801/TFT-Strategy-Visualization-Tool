...
const augmentData = [
    ...
    { id: 'Bulky Buddies I', name: '壯碩夥伴 I', tier: 1, description: '戰鬥開始時，如果至少有4名友軍從後兩排開始戰鬥，則我方隊伍增加12%攻速。' },
    ...
    { id: 'Fine Vintage', name: '寶貝古董', tier: 1, description: '留在備戰區4回合的完整道具會變為輔助鐵鉤。' },
    ...
    { id: 'Band of Thieves I', name: '神偷集團 I', tier: 1, description: '獲得1個麗思手套。在接下來的3個回合，你無法進行任何行動。在那之後，獲得20金錢。' },
    ...
    { id: 'Superstars I', name: '超級巨星 I', tier: 1, description: '戰鬥開始時，我方單位身旁如有超過1750生命的友軍，則所受傷害減少7%，持續直到戰鬥結束。' },
    ...
    { id: 'Risky Moves', name: '高風險高報酬', tier: 1, description: '失去20相手生命。經過7個玩家戰鬥回合後，獲得30金錢。' },
