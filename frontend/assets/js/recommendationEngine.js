...
const augmentData = [
    ...
    { id: 'cn', name: '一個Buff，兩個Buff', tier: 3, description: '獲得1個Buff及1個藍Buff及1件英雄裝備藍圖。' },
    { id: 'co', name: '三連勝 II', tier: 3, description: '獲得3個藍英雄，每單位獲得5%攻速。戰鬥開始時，初始藍8真英雄增加300生命和25%攻速。' },
    { id: 'cp', name: '不穩定的進化', tier: 3, description: '每次經驗值用盡+1，每升級都會獲得2生命值並有2次免費重抽機會。' },
    { id: 'cq', name: '值得等待 II', tier: 3, description: '隨機獲得1位2費英雄，每回合開始獲得1個民族飾物，持續到遊戲結束。' },
    { id: 'cr', name: '先鋒戰士之冠', tier: 3, description: '獲得1枚先鋒戰士徽章，1個保衛者之冠及1個史加爾。' },
    { id: 'cs', name: '先鋒戰士之環', tier: 3, description: '獲得1枚先鋒戰士徽章及1個布甲鎧。' },
    ...
    { id: 'cw', name: '加冕', tier: 3, description: '取得1名擁有皇身打造進攻性道具的魔像，每個階段開始時都會變得更強。' },
    { id: 'cx', name: '勝者發財', tier: 3, description: '每回合會多購買經驗值時，獲得2金錢，每次購買經驗值，都會刷新商店。' },
    ...
    { id: 'da', name: '召喚虛靈', tier: 3, description: '獲得1個強大的隨機魔靈。' },
    { id: 'db', name: '向上流動', tier: 3, description: '立即獲得1個神器盤點，且每進行10場玩家對戰回合可獲得1個神器盤點。神器是擁有獨特效果的強大道具。' },
    { id: 'dc', name: '吸取精華', tier: 3, description: '戰鬥開始，最多有6個裝備1件下這具的英雄，從最靠近召喚板塊的友軍身上獲得1件隨機完整道具的複製品。' },
    { id: 'dd', name: '地底寶藏 III', tier: 3, description: '接下來6個回合開始時(包含這一回合)，各獲得1個隨機掉落道具組件。' },
    { id: 'de', name: '堡壘之冠', tier: 3, description: '獲得1枚堡壘徽章及1個無畏衛士。' },
    { id: 'df', name: '堡壘之環', tier: 3, description: '獲得1枚堡壘徽章及1個防禦者。' },
    { id: 'dg', name: '壯碩夥伴 III', tier: 3, description: '我方寵位增加20%暴擊率，且技能可以暴擊。暴擊基礎傷害加20%獲取護盾量，持續3秒。' },
    { id: 'dh', name: '好運手套', tier: 3, description: '勇鬥手套必定會給你的英雄理想的道具，獲得2雙格門手套。7回合後，再獲得一雙格門手套。' },
    { id: 'di', name: '好運手套+', tier: 3, description: '勇鬥手套必定會給你的英雄理想的道具，獲得3副格門手套。' },
    { id: 'dj', name: '守望者之選', tier: 3, description: '隨等級提升，獲得的道具會越來越強。等級4：組件盤點；等級6：完整道具盤點；等級7：從5件盤光道具中擇1' },
    { id: 'dk', name: '射手之冠', tier: 3, description: '獲得1枚射手徽章及1個吉茵珂絲。' },
    { id: 'dl', name: '射手之環', tier: 3, description: '獲得1枚射手徽章及1個無盡之刃。' },
    { id: 'dm', name: '山寨版', tier: 3, description: '獲得1個輔助盤點及1個完整道具盤點。' },
    { id: 'dn', name: '巨獸決意', tier: 3, description: '獲得副撲克牌手套，出牌員每回合會隨機擲2件聖光道具。' },
    { id: 'do', name: '巨獸決意+', tier: 3, description: '獲得1個無盡之力，5場玩家戰門後，再獲得1個。無盡之力：極大大量攻擊與防禦能力值的神器' },
    ...
    { id: 'ds', name: '快拳連打', tier: 3, description: '獲得1支鳳凰手套，出牌員每回合會隨機擲2件聖光道具。' },
    { id: 'dt', name: '情緒管理', tier: 3, description: '你目前和之後取得的完整道具都會變為憤怒之刃。憤怒之刃：其額予45%防禦和鬼魂防禦，狂暴之刃每2層會降予1%物攻與與防攻。' },
    { id: 'du', name: '戰爭紅利 III', tier: 3, description: '敵軍死亡時，有45%機率會掉落戰利品。' },
    { id: 'dv', name: '戰略軍師之冠', tier: 3, description: '獲得1枚戰略軍師徽章及1個傻哦。' },
    { id: 'dw', name: '戰略軍師之環', tier: 3, description: '獲得1枚戰略軍師徽章，1個頑性神盾及1個艾克。' },
    { id: 'dx', name: '技師之冠', tier: 3, description: '獲得1枚技師徽章及1個魔門凱隊。' },
    { id: 'dy', name: '技師之環', tier: 3, description: '獲得1枚技師徽章，1副真石手套及1個希瓦娜。' },
    ...
    { id: 'eb', name: '投資策略 II', tier: 3, description: '結賭取一點利息，每方英雄永久獲得8最大生命，我方利息上限提升至7，獲得3金錢。' },
    { id: 'ec', name: '擲骰子', tier: 3, description: '獲得25金錢，我方利息上限提升至10。利息是指每千10金錢可獲得的額外金錢。' },
    { id: 'ed', name: '最大上限', tier: 3, description: '我方等級上限提升7，獲得1個盟約玩家操作，便我方人數+1，並獲得40金錢。' },
    { id: 'ee', name: '最終庫存', tier: 3, description: '每次結束玩家戰門後，獲得2玩家生命與1金錢。我方聯盟領袖也會提升跑速，立即獲得15金錢。' },
    { id: 'ef', name: '末日機器之冠', tier: 3, description: '獲得1枚末日機器徽章及1個古拉格斯。' },
    { id: 'eg', name: '末日機器之環', tier: 3, description: '獲得1枚末日機器徽章及1個趙信。' },
    { id: 'eh', name: '棋手廚房', tier: 3, description: '獲得1枚隨機徽章，6場玩家戰門後，獲得1件棋手披風。' },
    { id: 'ei', name: '極限之冠', tier: 3, description: '獲得1枚極限徽章及1個魔門凱隊。' },
    { id: 'ej', name: '極限之環', tier: 3, description: '獲得1枚極限徽章，1把鬼魅的狂暴之刃及1個瑞菲托。' },
    { id: 'ek', name: '模控機械移植 III', tier: 3, description: '你的英雄裝備一件道具可獲得200生命與30%物理攻擊。' },
    { id: 'el', name: '殺戮者之冠', tier: 3, description: '獲得1枚殺戮者徽章及1個賽文。' },
    { id: 'em', name: '殺戮者之環', tier: 3, description: '獲得1枚殺戮者徽章，1個正義手套及1個凱。' },
    { id: 'en', name: '泰坦之武', tier: 3, description: '獲得1枚速射徽章，1把無盡之刃及1個爆。' },
    { id: 'eo', name: '洞燭先機 II', tier: 3, description: '現在以及之間階段開始時，擷取3次，根據題數獲得不同獎勵。' },
    { id: 'ep', name: '活到老學到老', tier: 3, description: '我方不再獲得利息，立刻獲得15金錢。回合開始，獲得4經驗值。利息是指每擁10金錢可獲得的額外金錢。' },
    { id: 'eq', name: '活火爐', tier: 3, description: '戰鬥開始時，1個隨機1費英雄被回合升級至4星，並增加5%物攻與5魔攻。' },
    ...
    { id: 'et', name: '混沌召喚', tier: 3, description: '獲得1個虛空之門，每經過10次玩家戰門，再獲得1個。虛空之門應變增加30%攻速和80%全能吸血。' },
    { id: 'eu', name: '渾身是勁 III', tier: 3, description: '我方寵位立即增加12%攻速，每過一個回合，再增加2%。' },
    { id: 'ev', name: '潘朵拉的道具 III', tier: 3, description: '回合開始，各獲得1個隨機掉落道具組件。' },
    { id: 'ew', name: '炫目神速', tier: 3, description: '獲得1個虛空之門，每經過6次玩家戰門，再獲得1個。虛空之門應變增加40%攻速和25%全能吸血。' },
    { id: 'ex', name: '無可動搖', tier: 3, description: '獲得1個顫慄之光，真攻擊距離增加1格，且效果提升33%。' },
    { id: 'ey', name: '無盡軍勢', tier: 3, description: '獲得1個副撲克牌手套，出牌員每回合會隨機擲2件聖光道具。' },
    { id: 'ez', name: '無盡軍勢+', tier: 3, description: '獲得1個無盡之力，5場玩家戰門後，再獲得1個。無盡之力：極大大量攻擊與防禦能力值的神器' },
    { id: 'fa', name: '燃熱靈魂 II', tier: 3, description: '獲得1個輔助盤點及1個完整道具盤點。' },
    { id: 'fb', name: '狙擊武器 II', tier: 3, description: '獲得1件作升級道具及1個組件盤點。炫作升級道具可將道具升級為聖光道具！' },
    { id: 'fc', name: '現在我是主力', tier: 3, description: '取得1名擁有皇身打造進攻性道具的魔像，每個階段開始時都會變得更強。' },
    { id: 'fd', name: '生化過載', tier: 3, description: '戰鬥開始時，我方所有和排英雄成長非最中期的英雄的複製體，複製體的生命為真正生命的100%，且複製的傷害降低5%。' },
    { id: 'fe', name: '生日禮物', tier: 3, description: '每次我方升級時，獲得1名2星真英雄與1金錢，獲得真英雄的實用權。' },
    { id: 'ff', name: '畫龍點睛', tier: 3, description: '獲得1個虛空空間，每經過10次玩家戰門，再獲得1個。虛空空間應變增加30%攻速和80%全能吸血。' },
    { id: 'fg', name: '發電機之冠', tier: 3, description: '獲得1枚發電機徽章及1個伊澤。' },
    { id: 'fh', name: '發電機之環', tier: 3, description: '獲得1枚發電機徽章及1個伊芙琳。' },
    { id: 'fi', name: '百獸之冠', tier: 3, description: '獲得1枚百獸徽章及1個加里奧。' },
    { id: 'fj', name: '百獸之環', tier: 3, description: '獲得1枚百獸徽章及1個塔莉雅。' },
    { id: 'fk', name: '皎潔月光', tier: 3, description: '每次經驗值用盡+1，每升級都會獲得2生命值並有2次免費重抽機會。' },
    { id: 'fl', name: '盜墓者 II', tier: 3, description: '獲得1個盜墓道具盤點，每次有玩家死亡，即可盜走對方一件完整道具。' },
    { id: 'fm', name: '盧登回音 III', tier: 3, description: '獲得1個無盡之力，3場玩家戰門後，再獲得1個。無盡之力：極大大量攻擊與防禦能力值的神器' },
    { id: 'fn', name: '神諭之冠', tier: 3, description: '獲得1枚神諭集團徽章及1個龍戟。' },
    { id: 'fo', name: '神諭之環', tier: 3, description: '獲得1枚神諭集團徽章及1個蜃獅。' },
    { id: 'fp', name: '稜鏡票券', tier: 3, description: '獲得1枚虛電機徽章及1個伊芙琳。' },
    { id: 'fq', name: '稜鏡管道', tier: 3, description: '獲得1枚虛電機徽章及1個伊澤。' },
    { id: 'fr', name: '穿刺蓮花 II', tier: 3, description: '獲得3枚3/2真英雄，加將其中2位英雄升到3星，即會獲得1顆怒元素。' },
    { id: 'fs', name: '精打細算', tier: 3, description: '獲得1件作升級道具及1個組件盤點。炫作升級道具可將道具升級為聖光道具！' },
    { id: 'ft', name: '精算強化', tier: 3, description: '每場戰鬥中，我方最後死掉的隨機4位英雄增加40%物攻與50魔攻。' },
    { id: 'fu', name: '罪惡之冠', tier: 3, description: '獲得1枚罪惡集團徽章及1個斯維爾。' },
    { id: 'fv', name: '罪惡之環', tier: 3, description: '獲得1枚罪惡集團徽章，1把無盡之刃及1個薩勒斯。' },
    { id: 'fw', name: '聖光重構', tier: 3, description: '從5件聖光道具中擇1，獲得1台磁性卸除器。聖光道具是非常強大的完整道具！' },
    { id: 'fx', name: '聖物抉擇', tier: 3, description: '獲得1副護符之光，真攻擊距離增加1格，且效果提升33%。' },
    { id: 'fy', name: '腰帶多多', tier: 3, description: '閒置時，擷取升級最終選擇+1，在賺取免費重購買數量，獲得4金錢。' },
    { id: 'fz', name: '處刑者之冠', tier: 3, description: '獲得1枚處刑者徽章及1個賽維爾。' },
    { id: 'ga', name: '處刑者之環', tier: 3, description: '獲得1枚處刑者徽章，1個正義手套及1個兄弟。' },
    { id: 'gb', name: '虧機星期五', tier: 3, description: '格拉斯裝備1件道具的單位，將該道具升級至聖光等級，裝備聖光道具的單位增加4%生命，獲得2台磁性卸除器。凱特手套計為多件道具。' },
    { id: 'gc', name: '虧機星期五+', tier: 3, description: '格拉斯裝備1件道具的單位，將該道具升級至聖光等級，裝備聖光道具的單位增加4%生命，獲得2台磁性卸除器。凱特手套計為多件道具。' },
    { id: 'gd', name: '蠻勇之冠', tier: 3, description: '獲得1枚蠻勇徽章及1個古拉格斯。' },
    { id: 'ge', name: '蠻勇之環', tier: 3, description: '獲得1枚蠻勇徽章及1個趙信。' },
    { id: 'gf', name: '街頭狂魔之冠', tier: 3, description: '獲得1枚街頭狂魔徽章及1個古拉絲。' },
    { id: 'gg', name: '街頭狂魔之環', tier: 3, description: '獲得1枚街頭狂魔徽章，1把破防者及1個艾克。' },
    { id: 'gh', name: '訂閱服務', tier: 3, description: '獲得1個輔助盤點，現在以及每回合開始時，隨機每段開始時，商店中等待1枚徽章增加20生命。' },
    { id: 'gi', name: '詛咒之冠', tier: 3, description: '獲得1枚詛咒徽章及1個文森特。' },
    { id: 'gj', name: '買不手軟', tier: 3, description: '每次經驗值用盡+1，每升級都會獲得2生命值並有2次免費重抽機會。' },
    { id: 'gk', name: '質大於量', tier: 3, description: '獲得1個輔助盤點及1個完整道具盤點。' },
    { id: 'gl', name: '越戰越勇 III', tier: 3, description: '我方寵位立即增加12%攻速，每過一個回合，再增加2%。' },
    ...
    { id: 'go', name: '速射之冠', tier: 3, description: '獲得1枚速射徽章及1個瑞雯。' },
    { id: 'gp', name: '速射之環', tier: 3, description: '獲得1枚速射徽章及1個艾希。' },
    { id: 'gq', name: '避險基金', tier: 3, description: '獲得1個副護符之光，真攻擊距離增加1格，且效果提升33%。' },
    { id: 'gr', name: '金牛之冠', tier: 3, description: '獲得1枚開運金牛徽章及1個嘉文四世。' },
    { id: 'gs', name: '金牛之環', tier: 3, description: '獲得1枚開運金牛徽章，1把熔什什之齒及1個薩勒斯。' },
    { id: 'gt', name: '銅級之命 II', tier: 3, description: '每段使用一項銅級特性，我方寵位增加3.5%傷害增幅與1%額能力。' },
    { id: 'gu', name: '鏡之廳', tier: 3, description: '獲得1個Buff及1個藍Buff及1件英雄裝備藍圖。' },
    { id: 'gv', name: '長久之計', tier: 3, description: '獲得1個副護符之光，真攻擊距離增加1格，且效果提升33%。' },
    { id: 'gw', name: '開局新手包 I', tier: 3, description: '獲得1名隨機3星1費英雄，獲得8金錢。' },
    { id: 'gx', name: '陽壽局', tier: 3, description: '獲得3枚3/2真英雄，若將其中2位英雄升到3星，則會獲得1顆元素。' },
    { id: 'gy', name: '雙胞胎 III', tier: 3, description: '獲得3枚3/2真英雄，若將其中2位英雄升到3星，即會獲得1顆怒元素。' },
    { id: 'gz', name: '雙重目的', tier: 3, description: '獲得1個Buff及1個藍Buff及1件英雄裝備藍圖。' },
    { id: 'ha', name: '雙重空投物資', tier: 3, description: '獲得1個輔助盤點，現在以及每回合開始時，隨機每段開始時，商店中等待1枚徽章增加20生命。' },
    { id: 'hb', name: '電擊療法', tier: 3, description: '獲得1枚超電機徽章及1個伊澤。' },
    { id: 'hc', name: '電擊療法+', tier: 3, description: '獲得1枚超電機徽章及1個伊芙琳。' },
    { id: 'hd', name: '靈活變通', tier: 3, description: '獲得副護符之光，真攻擊範圍的英雄增加45%暴擊率。' },
    { id: 'he', name: '非凡冒險', tier: 3, description: '獲得3枚3/2真英雄，加將其中2位英雄升到3星，即會獲得1顆怒元素。' },
    { id: 'hf', name: '預料中的意外', tier: 3, description: '獲得1個無盡之力，5場玩家戰門後，再獲得1個。無盡之力：極大大量攻擊與防禦能力值的神器' },
